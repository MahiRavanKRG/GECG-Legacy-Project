...
function App() {
  ...
  return (
    <div className="App">
      {submitCorrectInformation ? <Main setsubmitCorrectInformation={setsubmitCorrectInformation}/> : <Home setsubmitCorrectInformation={setsubmitCorrectInformation} flip={flip} setFlip={setFlip}/>}
    </div>
  );
}
