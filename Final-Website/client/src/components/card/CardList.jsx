            ...
            <div className="card" key={card.id}>
              <div className="card-front">
                ...
                <div className="card-description">
                  ...
                  <div className="card-branch">{card.branch}</div>
                  <div className="card-btn">
                    <input type="submit" value="Read" className="card-read-more-btn" onClick={() => {
              ...
              <div className="card-back">
                ...
                dolore vel, natus possimus rem similique fuga necessitatibus
                sint, assumenda iusto repellendus sed doloribus eos
                consequuntur! Atque reiciendis omnis necessitatibus dolorum
                velit exercitationem autem.
