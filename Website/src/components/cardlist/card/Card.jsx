...
function Card({ card }) {
  ...
  return (
    <>
    {/* Main Card of Users */}
      <div className={`card ${cardFlip ? "card-fliped" : ""}`}>
        {/* Front Side of the Card */}
        <div className="card-front">
          <div className="card-logo flex-center">
            <img src="https://cdn-icons-png.flaticon.com/512/17/17004.png" alt="Card Logo" className="flex-center" />
          ...
          <div className="card-description">
            ...
            <div className="card-branch"><span>Branch : </span><b>{card.branch}</b></div>
            <div className="card-btn">
              <button onClick={() => {
                console.log("Ha chale 6")
                setCardFlip(true)
              }}>Read More</button>
            </div>
          </div>
